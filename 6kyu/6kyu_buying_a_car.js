...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
    ...
    while((totalSavings + depreciatedPriceOld) < depreciatedPriceNew){
        months += 1;
        if(months % 2 === 0){
            lossPercent += 0.5;
        }
        ...
        depreciatedPriceOld -= depreciatedPriceOld * (lossPercent / 100);
        depreciatedPriceNew -= depreciatedPriceNew * (lossPercent / 100);
    }

        return [ months, Math.round(totalSavings + depreciatedPriceOld - depreciatedPriceNew)];
